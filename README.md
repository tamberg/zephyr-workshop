...
## Workshop
> Note: This is a [new workshop](https://workshoptage.ch/workshops/2022/iot-embedded-programmierung-mit-zephyr-os/) for the [Workshop Days 2022](https://workshoptage.ch/) of [CH Open](https://www.ch-open.ch/). Feedback is welcome, please [create an issue](../../issues).
